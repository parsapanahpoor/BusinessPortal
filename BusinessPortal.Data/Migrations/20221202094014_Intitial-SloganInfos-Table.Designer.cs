...
namespace BusinessPortal.Data.Migrations
{
    ...
    [Migration("20221202094014_Intitial-SloganInfos-Table")]
    partial class IntitialSloganInfosTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BusinessPortal.Domain.Entities.Banners.Banners", b =>
                {
                    b.Property<decimal>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(20,0)");
                    ...
                    b.Property<string>("SliderImageTop")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("BusinessPortal.Domain.Entities.Slider.Slider", b =>
                {
                    b.Property<decimal>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(20,0)");
                    ...
                    b.Property<string>("SldierImageName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("BusinessPortal.Domain.Entities.Slogan.Slogan", b =>
                {
                    b.Property<decimal>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(20,0)");
            ...
            modelBuilder.Entity("BusinessPortal.Domain.Entities.Slogan.SloganInfo", b =>
                {
                    b.Property<decimal>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(20,0)");
            ...
            modelBuilder.Entity("BusinessPortal.Domain.Entities.Slogan.SloganInfo", b =>
                {
                    b.HasOne("BusinessPortal.Domain.Entities.Language.Language", "Language")
                        .WithMany("SloganInfos")
                        .HasForeignKey("LanguageId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("BusinessPortal.Domain.Entities.Slogan.Slogan", "Slogan")
                        .WithMany("SloganInfo")
                        .HasForeignKey("SloganId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
