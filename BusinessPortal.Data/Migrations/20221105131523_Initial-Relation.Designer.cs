...
namespace BusinessPortal.Data.Migrations
{
    ...
    [Migration("20221105131523_Initial-Relation")]
            ...
            modelBuilder.Entity("BusinessPortal.Domain.Entities.Advertisement.Advertisement", b =>
                {
                    ...
                    b.HasIndex("CountriesId")
                        .IsUnique()
                        .HasFilter("[CountriesId] IS NOT NULL");
            ...
            modelBuilder.Entity("BusinessPortal.Domain.Entities.Advertisement.Advertisement", b =>
                {
                    ...
                    b.HasOne("BusinessPortal.Domain.Entities.Countries.Countries", "Countries")
                        ...
                        .HasForeignKey("BusinessPortal.Domain.Entities.Advertisement.Advertisement", "CountriesId")
                        .OnDelete(DeleteBehavior.Restrict);
